...
var image="himagefall/은행잎.png";  //Image path should be given here
...
nht = dheight - 15; // 밑에서부터 15px정도 높이에서 사라지게. 대신 첫번째 내리는 이미지 말고 애니메이션이 작동하는 이미지부터 작동한다. 하지만 타이머에 if 를 달아줘서 ranrot을 초기에만 0.02초만에 초기화 하도록 하여 초기에도 스크롤바가 생기지 않게 한다.
